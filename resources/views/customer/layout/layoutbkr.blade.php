                ...
                <div class="col-md-6 col-sm-6 additional-nav">
                    <ul class="list-unstyled list-inline pull-right">
                      @if (Auth::guard('web')->user() == null)
                        <li><a href="{{route('customer.regis')}}">Đăng kí</a></li>
                        <li><a href="{{route('customer.login')}}">Đăng nhập</a></li>
                        @else
                        <li><a href="{{route('customer.logout')}}">Đăng xuất</a></li>
                        <li><a href="page-login.html">Cập nhật</a></li>
                        <li>Xin chào: {{Auth::guard('web')->user()->name}}</li>
                        @endif
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
    ...
    <div class="header">
      <div class="container">
        ...
        <div class="header-navigation">
          <ul>
            <li><a href="{{route('product.listcus',$id=0)}}">Tất cản sản phẩm</a></li>
            @foreach ($data1 as $type)
            <li><a href="{{route('product.listcus',$type->id)}}">{{$type->name}}</a></li>
            @endforeach
            @if (Auth::guard('web')->user() != null)
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-4">
            <ul class="list-unstyled list-inline pull-right">
              <li><img src="" alt="We accept Western Union" title="We accept Western Union"></li>
              <li><img src="" alt="We accept American Express" title="We accept American Express"></li>
              <li><img src="" alt="We accept MasterCard" title="We accept MasterCard"></li>
              <li><img src="" alt="We accept PayPal" title="We accept PayPal"></li>
              <li><img src="" alt="We accept Visa" title="We accept Visa"></li>
            </ul>
          </div>
          <!-- END PAYMENTS -->
          <!-- BEGIN POWERED -->
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-3">
                  <div class="product-main-image">
                    <img src="" alt="Cool green dress with red bell" class="img-responsive">
                  </div>
                  <div class="product-other-images">
                    <a href="javascript:;" class="active"><img alt="Berry Lace Dress" src=""></a>
                    <a href="javascript:;"><img alt="Berry Lace Dress" src=""></a>
                    <a href="javascript:;"><img alt="Berry Lace Dress" src=""></a>
                  </div>
                </div>
