...
@section('title','Thêm đơn vị giao hàng')
@section('css')
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/css/bootstrap.min.css" 
rel="stylesheet" integrity="sha384-F3w7mX95PdgyTmZZMECAngseQB83DfGTowi0iMjiWaeVhAn4FJkqJByhZMI3AhiU" crossorigin="anonymous">
@stop
@section('content')
<h1 class="text-center">Thêm đơn vị</h1>
<form method="POST" class="shipform">
    @csrf
    <div class="input-group flex-nowrap">
        <span class="input-group-text" id="addon-wrapping">Tên đơn vị</span>
        <input type="text" class="form-control" placeholder="Tên đơn vị:"
         aria-label="Username" aria-describedby="addon-wrapping" name="ship">
    </div>
    <br>
    <div class="input-group flex-nowrap">
        <span class="input-group-text" id="addon-wrapping">Giá cước</span>
        <input type="text" class="form-control" placeholder="Giá cước:"
