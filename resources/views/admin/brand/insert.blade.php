...
@stop
@section('content')
<h1 class="text-center">Thêm hãng</h1>
<form method="POST" class="brandform">
    @csrf
    <div class="input-group flex-nowrap">
        <span class="input-group-text" id="addon-wrapping">Hãng sản xuất</span>
        <input type="text" class="form-control" placeholder="Hãng sản xuất:"
         aria-label="Username" aria-describedby="addon-wrapping" name="brand">
      </div>
      <br>
