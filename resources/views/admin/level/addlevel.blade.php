...
<form method="POST" class="level">
    ...
    <div class="input-group flex-nowrap">
        <span class="input-group-text" id="addon-wrapping">Chức vụ</span>
        <input type="text" class="form-control" placeholder="Thêm chức vụ:"
         aria-label="Username" aria-describedby="addon-wrapping" name="level">
      </div>
      <br>
